...
generate_sparkle_appcast() {
  ...
  local release_tag="${RELEASE_TAG:-v1.0-rc2b}"
  ...
  /bin/cp "$ROOT_DIR/release-notes/1.0-rc2b.en.html" "$DIST_DIR/1.0-rc2b.en.html"
  /bin/cp "$ROOT_DIR/release-notes/1.0-rc2b.zh-Hans.html" "$DIST_DIR/1.0-rc2b.zh-Hans.html"
...
add_localized_release_notes() {
  local appcast="$1"
  local release_url="$2"
  local en_url="$release_url/1.0-rc2b.en.html"
  local zh_url="$release_url/1.0-rc2b.zh-Hans.html"
  local notes_xml
