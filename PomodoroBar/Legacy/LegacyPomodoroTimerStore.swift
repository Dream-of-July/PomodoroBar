...
@MainActor
final class LegacyPomodoroTimerStore: ObservableObject {
    ...
    @Published var completedFocusRounds: Int = 0
    @Published var todayCompletedCount: Int = 0
    @Published var focusDurationSeconds: Int = PomodoroPhase.focus.defaultDuration
    @Published var shortBreakDurationSeconds: Int = PomodoroPhase.shortBreak.defaultDuration
    @Published var longBreakDurationSeconds: Int = PomodoroPhase.longBreak.defaultDuration
    @Published var restCycle: [PomodoroPhase] = [.shortBreak, .shortBreak, .shortBreak, .longBreak]
